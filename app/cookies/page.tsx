      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "0 28px" }}>
        <section style={{ paddingTop: "100px", paddingBottom: "72px" }}>
          ...
          <h1 className="font-display" style={{ fontSize: "clamp(40px, 6vw, 64px)", fontWeight: 500, lineHeight: 1.05, letterSpacing: "-0.01em", marginBottom: "28px" }}>
            Cookie <em style={{ fontStyle: "italic" }}>Policy.</em>
          </h1>
...
const SECTIONS = [
  { heading: "What Are Cookies", placeholder: "Content coming soon." },
  { heading: "How We Use Cookies", placeholder: "Content coming soon." },
  { heading: "Essential Cookies", placeholder: "Content coming soon." },
  { heading: "Analytics Cookies", placeholder: "Content coming soon." },
  { heading: "Managing Cookies", placeholder: "Content coming soon." },
