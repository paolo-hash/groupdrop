      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "0 28px" }}>
        <section style={{ paddingTop: "100px", paddingBottom: "72px" }}>
          ...
          <h1 className="font-display" style={{ fontSize: "clamp(40px, 6vw, 64px)", fontWeight: 500, lineHeight: 1.05, letterSpacing: "-0.01em", marginBottom: "28px" }}>
            Terms of <em style={{ fontStyle: "italic" }}>Sale.</em>
          </h1>
...
const SECTIONS = [
  { heading: "Order Authorization", placeholder: "Content coming soon." },
  { heading: "Pricing & Collective Targets", placeholder: "Content coming soon." },
  { heading: "Payment & Billing", placeholder: "Content coming soon." },
  { heading: "Order Fulfillment & Shipping", placeholder: "Content coming soon." },
  { heading: "All Sales Final", placeholder: "Content coming soon." },
  { heading: "Damaged or Incorrect Items", placeholder: "Content coming soon." },
  { heading: "Product Authenticity", placeholder: "Content coming soon." },
