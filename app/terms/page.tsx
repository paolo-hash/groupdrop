      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "0 28px" }}>
        <section style={{ paddingTop: "100px", paddingBottom: "72px" }}>
          ...
          <h1 className="font-display" style={{ fontSize: "clamp(40px, 6vw, 64px)", fontWeight: 500, lineHeight: 1.05, letterSpacing: "-0.01em", marginBottom: "28px" }}>
            Terms of <em style={{ fontStyle: "italic" }}>Service.</em>
          </h1>
...
const SECTIONS = [
  { heading: "Acceptance of Terms", placeholder: "Content coming soon." },
  { heading: "Use of the Platform", placeholder: "Content coming soon." },
  { heading: "Membership & Accounts", placeholder: "Content coming soon." },
  { heading: "Group Purchases & Payment Authorization", placeholder: "Content coming soon." },
  { heading: "Intellectual Property", placeholder: "Content coming soon." },
  { heading: "Limitation of Liability", placeholder: "Content coming soon." },
  { heading: "Governing Law", placeholder: "Content coming soon." },
  { heading: "Changes to These Terms", placeholder: "Content coming soon." },
